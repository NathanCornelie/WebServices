  ...
  return (
    <>
      <div className="md:text-7xl text-4xl font-bold mb-6">
        ...
        <h3 className="md:text-5xl text-2xl mt-2">
      ...
      <div className="flex md:flex-row flex-col gap-2.5 mt-10 mb-30 items-center">
        ...
        <p className="md:w-1/2 text-xl text-muted-foreground max-w-2xl mx-auto">
          ...
          gagner du temps aux petites entreprises. Sites vitrines, applications
          métiers, automatisation des processus ou monitoring : nous développons
          des outils efficaces et personnalisés pour simplifier votre quotidien
          et améliorer votre performance. Chaque projet est conçu en fonction de
          vos besoins, avec un accompagnement clair, réactif et sur mesure.
        </p>
      </div>
      <div>
        ...
        <div className="flex flex-col md:flex-row justify-center gap-3">
          ...
          <Card className="py-3">
            <CardContent>
              <Image
                className="service_images filter grayscale"
                src="/monitoring.svg"
                alt="Monitoring"
                width={200}
                height={200}
